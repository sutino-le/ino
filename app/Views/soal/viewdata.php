    ...
    <div class="card">
        ...
        <div class="card-body mt-1">
            <div class="table-responsive">
                ...
                <table style="width: 100%;" id="dataSoal" class="table table-sm table-bordered table-hover dataTable dtr-inline collapsed">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Kategori</th>
...
<script>
    function listDataSoal() {
        var table = $('#dataSoal').dataTable({
            destroy: true,
            "processing": true,
            "serverSide": true,
            "order": [],
            "ajax": {
                "url": "<?= base_url() ?>/soal/listData",
                "type": "POST",
            },
            "colomnDefs": [{
                "targets": [0, 3],
