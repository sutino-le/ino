            ...
            <form action="<?= base_url('barang/simpan') ?>" class="formsimpan">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="brgnama" id="brgnama" class="form-control" placeholder="Masukan Barang...">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="brgharga" id="brgharga" class="form-control" placeholder="Masukan Harga...">
