                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="pgmnomor" id="pgmnomor" value="<?= $pgmnomor ?>" class="form-control" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="pgmtanggal" id="pgmtanggal" class="form-control" value="<?= date("Y-m-d") ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Nama Pengembalian" name="pengembaliannama" id="pengembaliannama" readonly>
                                <input type="hidden" name="pgmoleh" id="pgmoleh">
                                <input type="hidden" name="pgmuser" id="pgmuser" value="<?= session()->namauser ?>">
                                <div class="input-group-append">
                                    <button class="btn btn-outline-primary" type="button" id="tombolCariPegembalian" title="Cari Nama"><i class="fas fa-search"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Kode" name="pgmbrgkode" id="pgmbrgkode">
                                <div class="input-group-append">
                    ...
                    <div class="col-lg-1">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="brgstok" id="brgstok" placeholder="Stok" readonly>
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pgmketerangan" id="pgmketerangan" placeholder="keterangan" autocomplete="off">
