            ...
            <li class='list-group-item'>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="ktp_nomor" id="ktp_nomor" maxlength="16" minlength="16"
                                class="form-control" placeholder="Masukan Nomor KTP...">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="">RT</label>
                            <input type="text" name="ktp_rt" id="ktp_rt" class="form-control"
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="">RW</label>
                            <input type="text" name="ktp_rw" id="ktp_rw" class="form-control"
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="kota_kabupaten" id="kota_kabupaten" class="form-control"
                                placeholder="Masukan Kota / Kabupaten..." readonly>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="ktp_hp" id="ktp_hp" class="form-control"
