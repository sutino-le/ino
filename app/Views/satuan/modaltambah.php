            ...
            <form action="<?= base_url('satuan/simpan') ?>" class="formsimpan">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="satnama" id="satnama" class="form-control" placeholder="Masukan Satuan...">
                        <div class="invalid-feedback errorSatNama"></div>
                    </div>

                    <div class="form-group">
                        <label for="">Singkatan</label>
                        <input type="text" name="satinisial" id="satinisial" class="form-control" placeholder="Masukan Satuan...">
