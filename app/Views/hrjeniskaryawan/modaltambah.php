...
<div class="modal fade" id="modalTambah" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('hrjeniskaryawan/simpan') ?>" class="formsimpan">
                <?= csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jknama" id="jknama" class="form-control"
                ...
                if (response.sukses) {
                    Swal.fire({
                        ...
                        text: response.sukses +
                            ", Apakah ingin menambah Jenis Karyawan ?",
                        icon: 'success',
