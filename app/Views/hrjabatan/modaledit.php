...
<div class="modal fade" id="modalEdit" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('hrjabatan/updatedata') ?>" class="formsimpan">
                <?= csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="jabatanid" id="jabatanid" value="<?= $jabatanid ?>">

                    <div class="form-group">
                        <label for="">Nama Jabatan</label>
                        <input type="text" name="jabatannama" id="jabatannama" value="<?= $jabatannama ?>"
                            class="form-control" placeholder="Masukan Jabatan...">
