            ...
            <form action="<?= base_url('barang/updatedata') ?>" class="formsimpan">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="brgnama" id="brgnama" value="<?= $brgnama ?>" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="brgkapasitas" id="brgkapasitas" value="<?= $brgkapasitas ?>"
                            class="form-control" placeholder="Masukan kapasitas...">
                    </div>

                    <div class="col-sm my-1">
                        <label for="">Panjang</label>
                        <div class="input-group">
                            <input type="text" name="brgpanjang" id="brgpanjang" value="<?= $brgpanjang ?>"
                                class="form-control" placeholder="Masukan Panjang...">
                    ...
                    <div class="col-sm my-1">
                        ...
                        <div class="input-group">
                            <input type="text" name="brglebar" id="brglebar" value="<?= $brglebar ?>"
                                class="form-control" placeholder="Masukan Lebar...">
                            <div class="input-group-prepend">
                                <div class="input-group-text">mm</div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm my-1">
                        ...
                        <div class="input-group">
                            <input type="text" name="brgtinggi" id="brgtinggi" value="<?= $brgtinggi ?>"
                                class="form-control" placeholder="Masukan Tinggi...">
                            <div class="input-group-prepend">
                                <div class="input-group-text">mm</div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="brgharga" id="brgharga" value="<?= $brgharga ?>" class="form-control"
